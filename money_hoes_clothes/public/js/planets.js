function getPlanets(){
    ...
    function makeSphere( x, y, z, size, opac, texture){
    ...
    // function setRotation(name) {



    // // requestAnimationFrame( animateSun );

    // name.rotation.x = (60/180)*Math.PI;
    // name.rotation.y = Date.now() * 0.0001;
    ...
    function makeSun(){
        makeSphere( 0,0,0, 5, 1.0, sunTexture );
        makeSphere( 0,0,0, 5.1, 0.6, sunTexture );
        // setRotation(sun);
        // setRotation(sun2);
    ...
    function makeMercury(){
        makeSphere( 6,0,0, .5, 1.0, mercuryTexture);
        makeOrbit(6);
    }

    function makeVenus(){
        makeSphere( 10.5,0,0, 1.5, 1.0, venusTexture);
        makeOrbit( 10.5 );
    }

    function makeEarth(){
        makeSphere( 15,0,0, 1.7 , 1.0, earthTexture);
        makeOrbit( 15 );
    }

    function makeMars(){
        makeSphere( 22.5,0,0, .9 , 1.0, marsTexture);
        makeOrbit( 22.5 );
    }

    function makeJupiter(){
        makeSphere( 77.5,0,0, 3.2 , 1.0, jupiterTexture);
        makeOrbit( 77.5 );
    }

    function makeSaturn(){
        makeSphere( 142,0,0, 2.8 , 1.0, saturnTexture);
        makeOrbit( 142 );
    }

    function makeUranus(){
        makeSphere( 262,0,0, 2.2 , 1.0, uranusTexture);
        makeOrbit( 262 );
    }


    function makeNeptune(){
        makeSphere( 450,0,0, 2 , 1.0, neptuneTexture);
        makeOrbit( 450 );
    }

    function makePluto(){
        makeSphere( 650,0,0, 2 , 1.0, plutoTexture);
        makeOrbit( 650 );
    }
